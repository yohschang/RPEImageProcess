...
class RetinalPigmentEpithelium(Base):
    ...
    month = Column('Month', String(5))
    day = Column('Day', String(5))
    ...
    def __repr__(self):
        ...
        return repr_str.format(self.id, self.year+self.month+self.day, self.label, self.time_lapse_num, self.img_path,
